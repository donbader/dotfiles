...
**Note**: The actual implementation should construct these inline comments programmatically based on your analysis in Phase 3-4. Use Bash to build the command with all inline comments.
