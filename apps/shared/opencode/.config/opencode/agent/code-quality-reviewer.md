...
**Shared Context**: You receive a shared context object (see `shared/context-schema.md`) containing PR metadata, codebase patterns, and architectural context.
...
**Comment Template**:
```markdown
⚠️ **Important - Deep Nesting (Readability)**
...
- ✅ Provides educational explanations with code examples
- ✅ Suggests concrete refactorings with migration paths
